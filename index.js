...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
  ...
  `nestedFunction() is a closure which means nestedFunction() can reach out of it's scope to grab a variable defined in an outer function`
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(data){
    const totalUSApop = data.reduce(function(acc, item){
